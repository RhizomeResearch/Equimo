...
- Modality-specific namespaces: `equimo.vision`, `equimo.language`, `equimo.audio`, `equimo.tabular`, `equimo.time_series`
...
| `equimo.time_series` | Experimental time-series models and layers, currently the raw T0 backbone |
