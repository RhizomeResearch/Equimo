...
from equimo.time_series.models.t0 import T0, _T0_REGISTRY
...
def parse_args(argv=None):
    ...
    parser.add_argument(
        "--checkpoint",
        type=Path,
        help="Local model.safetensors from a pinned T0-alpha checkout.",
    )
...
def main(argv=None):
    ...
    print(
        ...
        f"checkpoint={args.checkpoint or 'Hugging Face'} seed={args.seed} "
